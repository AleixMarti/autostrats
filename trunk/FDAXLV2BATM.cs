...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FDAXLV2BATM : Strategy
    {
        #region Variables
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.Stop, 0, High [1] + PrevBarsPlusTicks * TickSize, TimeInForce.Day, orderId, "FDAX_long_5R_V2B", atmStrategyId);	
			...
			if ( orderId.Length > 0)
			{
				...
				{
				Print("108   Cancel the FDAXLV2BATM order ");	

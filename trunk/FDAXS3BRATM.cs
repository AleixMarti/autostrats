...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FDAXS3BRATM : Strategy
    {
        #region Variables
		...
		private int prevBarsMinusTicks = 3; // Default setting for PrevBarsPlusTicks
        ...
        {
            Print("43 Initialise FDAXS3BRATM");
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, 0, Low [1] - prevBarsMinusTicks * TickSize, TimeInForce.Day, orderId, "FDAX_short_5R_3BR", atmStrategyId);
                barNumberOfOrder = CurrentBar;
				Print("74 AtmStrategyCreate FDAXS3BRATM ");
				...
				
			{
				...
				if (Close [0] + 6 * TickSize > Low[1] &&(status[2] == "Accepted" || status[2] == "Working" || status[2] == "Pending"))
				
				{
				Print("108 ATM cancel FDAXS3BRATM order");	
				...
				{
				Print("109 reset the strategy id");

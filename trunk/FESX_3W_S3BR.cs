...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FESX_3W_S3BR : Strategy
    {
        #region Variables
        ...
        {
            Print("43 Initialise FESX_3W_S3BR");
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, 0, Low [1] - prevBarsMinusTicks * TickSize, TimeInForce.Day, orderId, "FESX_3W_S3BR", atmStrategyId);
                barNumberOfOrder = CurrentBar;
				Print("74 AtmStrategyCreate FESX_3W_S3BR ");
				...
				
			{
				...
				{
				Print("108 ATM cancel FESX_3W_S3BR order");	
				...
				if (atmStrategyId.Length > 0)
			{
				...
				Print("126 At the end of  FESX_3W_S3BR");

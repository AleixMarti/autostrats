...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FESX_3W_SV2B : Strategy
    {
        #region Variables
        ...
        {
            Print("43 Initialise FESX_3W_SV2B");
			...
			
        {
			...
			if (Position.MarketPosition == MarketPosition.Flat 
                ...
                && Close [2] <= Open [2]
				&& Close [1] <= Open [1]
				&& Close [1] - PrevBarsMinusTicks * TickSize < GetCurrentAsk())
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, 0, Close [1] - PrevBarsMinusTicks * TickSize , TimeInForce.Day, orderId, "FESX_3W_SV2B", atmStrategyId);	
                barNumberOfOrder = CurrentBar;
				Print("74 AtmStrategyCreate FESX_3W_SV2B ");
			}
			...
			if (orderId.Length > 0)
			{
				...
				{
					Print("92 FESX_3W_SV2B Reset the strategy id if filled/cancelled or rejected");	
				...
				{
				Print("99 ATM cancel FESX_3W_SV2B order");	
				...
				{
				Print("108 FESX_3W_SV2B reset the strategy id");
				...
				if (atmStrategyId.Length > 0)
			{
				...
				Print("126 At the end of FESX_3W_SV2B");

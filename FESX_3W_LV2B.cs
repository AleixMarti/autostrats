...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FESX_3W_LV2B : Strategy
    {
        #region Variables
        ...
        {
			Print("43 Initialize FESX_3W_LV2B ");
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.Stop, 0, High [1] + PrevBarsPlusTicks * TickSize, TimeInForce.Day, orderId, "FESX_3W_LV2B", atmStrategyId);	
			    Print("79 AtmStrategyCreate FESX_3W_LV2B ");
			...
			if ( orderId.Length > 0)
			{
				...
				{
				Print("108   Cancel the FESX_3W_LV2B order ");	
			...
			if (atmStrategyId.Length > 0 && GetAtmStrategyMarketPosition(atmStrategyId) == MarketPosition.Flat)
				{
				Print("112 FESX_3W_LV2B Reset the strategy id");
			...
			if (atmStrategyId.Length > 0)
			{
				...
				Print ("120 FESX_3W_LV2B Getting to end of strat"); 

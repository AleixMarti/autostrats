...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FDAXSV2BATM : Strategy
    {
        #region Variables
        ...
        {
            Print("43 Initialise FDAXSV2BATM");
			...
			
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, 0, Low [1] - PrevBarsMinusTicks * TickSize , TimeInForce.Day, orderId, "FDAX_short_5R_V2B", atmStrategyId);	
                barNumberOfOrder = CurrentBar;
				Print("74 AtmStrategyCreate FDAXSV2BATM ");
			}
			...
			if (orderId.Length > 0)
			{
				...
				{
				Print("99 ATM cancel FDAXSV2BATM order");	

...
namespace NinjaTrader.Strategy
{
    ...
    public class TF_ATM_cancel_2W : Strategy
    {
        #region Variables
        ...
        protected override void OnBarUpdate()
        {
            ...
            // **** YOU MUST HAVE AN ATM STRATEGY TEMPLATE NAMED 'TF_long_3W_3BR' and 'TF_short_3W_3BR' CREATED IN NINJATRADER (SUPERDOM FOR EXAMPLE) FOR THIS TO WORK  you can create your own****
                               ...
                               
                        {
                                ...
                                AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.Stop, 0, High[1] + PrevBarsPlusTicks * TickSize, TimeInForce.Day, orderIdL, "TF_long_2W_3BR", atmStrategyIdL);	
                               ...
                               
                        {
                                ...
                                AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, 0, Low[1] - prevBarsMinusTicks * TickSize, TimeInForce.Day, orderIdS, "TF_short_2W_3BR", atmStrategyIdS);

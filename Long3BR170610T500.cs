...
namespace NinjaTrader.Strategy
{
    ...
    public class Long3BR170610T500 : Strategy
    {
        #region Variables
        ...
        protected override void OnBarUpdate()
        {
			...
			if (orderId.Length == 0 && atmStrategyId.Length == 0 && (NBarsDown(3, true, true, true)[0] > 0))
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.StopLimit, High[0] + PrevBarPlusTicks * TickSize, 0, TimeInForce.Day, orderId, "L3BRESATM170610T500", atmStrategyId);
			}

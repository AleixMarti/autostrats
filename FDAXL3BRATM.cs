...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FDAXL3BRATM : Strategy
    {
        #region Variables
		...
		private int prevBarsPlusTicks = 3; // Default setting for PrevBarsPlusTicks
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.Stop, 0, High[1] + PrevBarsPlusTicks * TickSize, TimeInForce.Day, orderId, "FDAX_long_5R_3BR", atmStrategyId);	
			    barNumberOfOrder = CurrentBar;
				Print("81 AtmStrategyCreate FDAXL3BR");
			}
			...
			
			{
				...
				{
					Print("100 FDAXL3BR Reset the strategy id if filled/cancelled or rejected");	
				...
				{
				Print("108 ATM cancel FDAXL3BR order");	
			...
			if (atmStrategyId.Length > 0 && GetAtmStrategyMarketPosition(atmStrategyId) == MarketPosition.Flat)
				{
				Print("117 FDAXL3BR reset the strategy id");
			...
			if (atmStrategyId.Length > 0)
			{
				...
				Print("126 At the end of FDAXL3BR");

...
{
    /// <summary>
    /// Long 3BR with repeat up to 3rd bar after 3BR signal.
    /// </summary>
    [Description("Long 3BR with repeat up to 3rd bar after 3BR signal.")]
    public class Long3BR220510 : Strategy
    {
        #region Variables
        // Wizard generated variables
        private int contractAmount = 2; // Default setting for ContractAmount
        ...
        protected override void Initialize()
        {
            ...
            Add(NBarsDown(3, true, true, true));
            Add(NBarsDown(3, true, true, true));
            SetProfitTarget("3BRLONG0", CalculationMode.Ticks, ProfitTarget);
            SetProfitTarget("3BRLONG1", CalculationMode.Ticks, ProfitTarget);
            SetProfitTarget("3BRLONG2", CalculationMode.Ticks, ProfitTarget);
            SetProfitTarget("3BRLONG3", CalculationMode.Ticks, ProfitTarget);
        ...
        protected override void OnBarUpdate()
        {
            ...
            {
                EnterLongStop(DefaultQuantity, High[0] + PrevBarPlusTicks * TickSize, "3BRLONG0");
            }
            ...
            {
                EnterLongStop(DefaultQuantity, High[1] + PrevBarPlusTicks * TickSize, "3BRLONG1");
            }
            ...
            {
                EnterLongStop(DefaultQuantity, High[2] + PrevBarPlusTicks * TickSize, "3BRLONG2");
            }
            ...
            {
                EnterLongStop(DefaultQuantity, High[3] + PrevBarPlusTicks * TickSize, "3BRLONG3");
            }
        ...
        public int TrailStop
        {
            ...
            set { trailStop = Math.Max(8, value); }
        }
...
<NinjaTrader>
  <Name>Long3BR220510</Name>
  <CalculateOnBarClose>True</CalculateOnBarClose>
  <Description>Long 3BR with repeat up to 3rd bar after 3BR signal.</Description>
  <Parameters>
    <Parameter>
      <Default1>
      </Default1>

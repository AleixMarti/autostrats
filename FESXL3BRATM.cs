...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class FESXL3BRATM : Strategy
    {
        #region Variables
        ...
        {
            Print("43 Initialise FESX_3W_L3BR");
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.Stop, 0, High[1] + PrevBarsPlusTicks * TickSize, TimeInForce.Day, orderId, "FESX_3W_L3BR", atmStrategyId);	
			    barNumberOfOrder = CurrentBar;
				Print("81 AtmStrategyCreate FESX_3W_L3BR");
			}
			...
			
			{
				...
				{
					Print("100 FESX_3W_L3BR Reset the strategy id if filled/cancelled or rejected");	
				...
				{
				Print("108 ATM cancel FESX_3W_L3BR order");	
			...
			if (atmStrategyId.Length > 0 && GetAtmStrategyMarketPosition(atmStrategyId) == MarketPosition.Flat)
				{
				Print("117 FESX_3W_L3BR reset the strategy id");
			...
			if (atmStrategyId.Length > 0)
			{
				...
				Print("126 At the end of FESX_3W_L3BR");

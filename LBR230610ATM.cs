...
namespace NinjaTrader.Strategy
{
    ...
    /// 3BR long with ATM
    /// </summary>
    [Description("3BR long with ATM")]
    public class LBR230610ATM : Strategy
    {
        #region Variables
        ...
        protected override void OnBarUpdate()
        {
			...
			if (orderId.Length == 0 && atmStrategyId.Length == 0 && (NBarsDown(3, true, true, true)[0] > 0))
			{
				...
				AtmStrategyCreate(Cbi.OrderAction.Buy, OrderType.StopLimit, High[0] + PrevBarPlusTicks * TickSize, 0, TimeInForce.Day, orderId, "T3BRLongES090610", atmStrategyId);
			}

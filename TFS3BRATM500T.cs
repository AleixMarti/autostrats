...
namespace NinjaTrader.Strategy
{
    ...
    /// </summary>
    [Description("")]
    public class TFS3BRATM500T : Strategy
    {
        #region Variables
		private string	atmStrategyId		= string.Empty;
		private string	orderId				= string.Empty;
		
		private int prevBarsMinusTicks = 1; // Default setting for PrevBarsMinusTicks
        ...
        protected override void OnBarUpdate()
        {
			...
			
			{
			    ...
			    //AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, Low[0] + prevBarsMinusTicks * TickSize, 0, TimeInForce.Day, orderId, "ES_short_500T", atmStrategyId);
				//AtmStrategyCreate(Cbi.OrderAction.Sell, OrderType.Stop, Low[0] + prevBarsMinusTicks * TickSize, 0, TimeInForce.Day, orderId, "ES_short_500T", atmStrategyId);

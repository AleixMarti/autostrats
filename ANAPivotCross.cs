...
{
    /// <summary>
    /// Long/Short after pivot cross
    /// </summary>
    [Description("Long/Short after pivot cross")]
    public class ANAPivotCross : Strategy
    {
        #region Variables
        ...
        private int trailStopTicks = 4; // Default setting for TrailStopTicks
        private int stopLossTicks = 8; // Default setting for StopLossTicks
        ...
        {
            Add(anaPivotsDailyV16(10, anaPivotStylesPD16.Floor, anaPlotAlignPD16.Left, NinjaTrader.Data.HLCCalculationMode.CalcFromIntradayData, true, 15));
            Add(anaPivotsDailyV16(10, anaPivotStylesPD16.Floor, anaPlotAlignPD16.Left, NinjaTrader.Data.HLCCalculationMode.CalcFromIntradayData, true, 15));
            Add(anaPivotsDailyV16(10, anaPivotStylesPD16.Floor, anaPlotAlignPD16.Left, NinjaTrader.Data.HLCCalculationMode.CalcFromIntradayData, true, 15));
            SetProfitTarget("", CalculationMode.Ticks, TrailStopTicks);
            SetStopLoss("", CalculationMode.Ticks, StopLossTicks, true);
            SetTrailStop("AnaLong", CalculationMode.Ticks, TrailStopTicks, true);
            SetTrailStop("AnaShort", CalculationMode.Ticks, TrailStopTicks, true);
        ...
        {
            // Condition set 1
            if (CrossAbove(Median, anaPivotsDailyV16(10, anaPivotStylesPD16.Floor, anaPlotAlignPD16.Left, HLCCalculationMode.CalcFromIntradayData, true, 15).PP, 1)
                && Position.MarketPosition == MarketPosition.Flat)
            {
                EnterLong(ContractAmount, "AnaLong");
            }
            ...
            {
                EnterShort(ContractAmount, "AnaShort");
            }
            ...
            {
                EnterLong(ContractAmount, "ANAlong1");
            }
            ...
            if (Position.MarketPosition == MarketPosition.Flat
                && CrossBelow(Median, anaPivotsDailyV16(10, anaPivotStylesPD16.Floor, anaPlotAlignPD16.Left, HLCCalculationMode.CalcFromIntradayData, true, 15).PP, 1))
            {
                EnterShort(ContractAmount, "ANAshort1");
            }
        }
        ...
        public int TrailStopTicks
        {
            ...
            set { trailStopTicks = Math.Max(6, value); }
        }
        ...
        public int StopLossTicks
        {
            ...
            set { stopLossTicks = Math.Max(8, value); }
        }
        #endregion
    }
}
...
<NinjaTrader>
  <Name>ANAPivotCross</Name>
  <CalculateOnBarClose>False</CalculateOnBarClose>
  <Description>Long/Short after pivot cross</Description>
  <Parameters>
    <Parameter>
      <Default1>
      </Default1>
